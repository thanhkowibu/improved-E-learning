...
export default function RegisterPage() {
  ...
  const {
    ...
    resolver: zodResolver(registerSchema) as import("react-hook-form").Resolver<RegisterOutput>,
  ...
  return (
    <div className="space-y-7">
      ...
      <div className="text-center space-y-1">
        ...
        <p className="text-sm text-slate-500">Start learning today — it&apos;s free</p>
      </div>
            ...
            {(["STUDENT", "TEACHER"] as const).map((role) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 text-sky-500 ml-auto shrink-0">
